...
public final class Utils {
    ...
    public static Object createFromJSON(String json, Form form) {
    ...
    public static Object getClassFieldAnyway(String fieldName) throws IllegalAccessException {
        return getClassField(fieldName, new ArrayList<>(filterCompositeFields(currentSite)), UIElement.class);
    }
    ////////////
